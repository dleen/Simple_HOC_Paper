...
p2 <- p2 + theme(axis.ticks = element_line(size = 0.1), 
                axis.ticks.length = unit(0.05, "cm"))
...
p2_1 <- p2_1 + theme(axis.ticks = element_line(size = 0.1), 
                    axis.ticks.length = unit(0.05, "cm"))
...
fig_data_2b$Rho <- ordered(fig_data_2b$Rho, 
                           levels = rev(c("Large", "Med", "Small")))
...
p2b <- p2b + scale_y_continuous(limits=c(0,8e-02),
                                breaks=c(0,2e-02,4e-02,6e-02,8e-02),
                                labels=c(0,2,4,6,8))
p2b <- p2b + theme(axis.ticks = element_line(size = 0.1), 
                  axis.ticks.length = unit(0.05, "cm"))
...
fig_data_2c$Mu <- ordered(fig_data_2c$Mu, 
                          levels = rev(c("Large", "Med", "Small")))
...
p2c <- p2c + scale_x_continuous(limits = c(4, 100), 
                                breaks = c(4, 25, 50, 75, 99.5), 
                                labels = c(4, 25, 50, 75, 100))
p2c <- p2c + scale_y_continuous(limits=c(0,3e-02),
                                breaks=c(0,1e-02,2e-02,3e-02),
                                labels=c(0,1,2,3))
...
p2c <- p2c + theme(axis.title.y = element_text(angle = 90, 
                                            vjust = 0.2, 
                                            size = 10))
