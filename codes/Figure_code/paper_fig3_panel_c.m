...
mu_range = [0.1,0.2,0.3];
rho_vals_DG = [0.242,0.19,0.17];
rho_vals_LF = [0.367,0.375,0.422];
mu_vals_LF = [-60.77,-59.05,-57.74];
mu_vals_DG = [-1.28,-0.84,-0.525];
...
for k=1:length(mu_range)
    ...
    for N=4:2:100
        ...
        MM{1} = importdata(strcat('./numerical_data/fig2rho/fig_2rho_',...
            int2str(N),'_',num2str(mu_range(k)),'.dat'),' ');
