...
for i=1:NT
    [mu_05(i),rho_05(i),sigma,P_DG_05(:,i)]=DG_statistics(0.132,-1.28,N);
end
...
for i=1:NT
    [mu_1(i),rho_1(i),sigma,P_DG_1(:,i)]=DG_statistics(0.242,-1.28,N);
end

P_DG_err_1 = std(P_DG_1,0,2)/sqrt(NT);
m_DG_err_1 = std(mu_1)/sqrt(NT);
r_DG_err_1 = std(rho_1)/sqrt(NT);

P_DG_mean_1 = mean(P_DG_1,2);
m_DG_mean_1 = mean(mu_1);
r_DG_mean_1 = mean(rho_1);
...
for i=1:NT
    [mu_25(i),rho_25(i),sigma,P_DG_25(:,i)]=DG_statistics(0.502,-1.28,N);
end
