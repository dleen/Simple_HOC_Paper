...
for i=1:NT
    [mu_05(i),rho_05(i),sigma,P_DG_05(:,i)]=DG_statistics(0.18,-1.64,N);
end
...
for i=1:NT
    [mu_1(i),rho_1(i),sigma,P_DG_1(:,i)]=DG_statistics(0.305,-1.64,N);
end
...
for i=1:NT
    [mu_25(i),rho_25(i),sigma,P_DG_25(:,i)]=DG_statistics(0.568,-1.64,N);
end
