...
for i=1:NT
    [mu_LF_05(i),rho_LF_05(i),P_LF_05(:,i),cv,dbl]=...
        EIF_filter(-58.87,0.22,4.925,N,'mfn','lnl_full','normed');
    [mu_LF_05_none(i),rho_LF_05_none(i),P_LF_05_none(:,i),cv,dbl]=...
        EIF_filter(-59.07,0.199,4.87,N,'mfn','lnl_full','none');    
end
...
for i=1:NT
    [mu_LF_1(i),rho_LF_1(i),P_LF_1(:,i),cv,dbl]=...
        EIF_filter(-59.05,0.375,4.925,N,'mfn','lnl_full',10,'normed');
    [mu_LF_1_none(i),rho_LF_1_none(i),P_LF_1_none(:,i),cv,dbl]=...
        EIF_filter(-59.34,0.355,4.87,N,'mfn','lnl_full',10,'none');    
end
...
for i=1:NT
    [mu_LF_25(i),rho_LF_25(i),P_LF_25(:,i),cv,dbl]=...
        EIF_filter(-60.70,0.584,6.23,N,'mfn','lnl');
end
