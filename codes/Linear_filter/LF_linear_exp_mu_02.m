...
for i=1:NT
    [mu_LF_05(i),rho_LF_05(i),P_LF_05(:,i),cv,dbl]=...
        EIF_filter(-57.99,0.18,6.295,N,'mfn','l',10,'normed');
    [mu_LF_05_none(i),rho_LF_05_none(i),P_LF_05_none(:,i),cv,dbl]=...
        EIF_filter(-58.35,0.173,6.19,N,'mfn','l',10,'none');    
end
...
for i=1:NT
    [mu_LF_1(i),rho_LF_1(i),P_LF_1(:,i),cv,dbl]=...
        EIF_filter(-58.3,0.365,6.295,N,'mfn','l',10,'normed');
    [mu_LF_1_none(i),rho_LF_1_none(i),P_LF_1_none(:,i),cv,dbl]=...
        EIF_filter(-58.74,0.365,6.19,N,'mfn','l',10,'none');
end
...
for i=1:NT
    [mu_LF_25(i),rho_LF_25(i),P_LF_25(:,i),cv,dbl]=...
        EIF_filter(-60.13,0.735,6.295,N,'mfn','l',10,'normed');
    [mu_LF_25(i),rho_LF_25(i),P_LF_25(:,i),cv,dbl]=...
        EIF_filter(-62.6,0.89,6.19,N,'mfn','l',10,'none');
end
