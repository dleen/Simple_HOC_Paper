...
for i=1:NT
    ...
    EIF_filter_nl_change(-59.15,0.33,5.15,N,'mfn','lnl_full',10,'normed');
    [mu_LF_05_none(i),rho_LF_05_none(i),P_LF_05_none(:,i),cv,dbl]=...
    EIF_filter_nl_change(-59.3,0.304,5.08,N,'mfn','lnl_full',10,'none');
end
...
for i=1:NT
    ...
    EIF_filter_nl_change(-59.52,0.494,5.15,N,'mfn','lnl_full',10,'normed');
    [mu_LF_1_none(i),rho_LF_1_none(i),P_LF_1_none(:,i),cv,dbl]=...
    EIF_filter_nl_change(-59.6,0.44,5.08,N,'mfn','lnl_full',10,'none');    
end
