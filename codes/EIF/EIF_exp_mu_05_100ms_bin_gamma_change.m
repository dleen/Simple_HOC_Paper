...
%parfor i=1:NT
for i=1:NT
    [vals_05(:,i),P_EIF_05(:,i)]=EIF_statistics_100ms_long(-60.88,0.168,6.23,N);
end
toc
...
%parfor i=1:NT
for i=1:NT
    [vals_1(:,i),P_EIF_1(:,i)]=EIF_statistics_100ms_long(-60.88,0.3,6.23,N);
end
...
%parfor i=1:NT
for i=1:NT
    [vals_25(:,i),P_EIF_25(:,i)]=EIF_statistics_100ms_long(-60.88,0.585,6.23,N);
end
%matlabpool close
