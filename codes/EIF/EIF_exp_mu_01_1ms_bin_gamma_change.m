...
if(exist('./EIF_statistics_1ms.mexmaci64','file')~=3)
    mex ./mex_source/mex_main.cpp...
        ...
        -lm -lgsl -lgslcblas -output EIF_statistics_1ms
end
...
%parfor i=1:NT
for i=1:NT
    [vals_05(:,i),P_EIF_05(:,i)]=EIF_statistics_1ms(-47.2,0.5,6.23,N);
end
toc
...
%parfor i=1:NT
for i=1:NT
    [vals_1(:,i),P_EIF_1(:,i)]=EIF_statistics_1ms(-47.2,0.728,6.23,N);
end
...
%parfor i=1:NT
for i=1:NT
    [vals_25(:,i),P_EIF_25(:,i)]=EIF_statistics_1ms(-47.2,0.941,6.23,N);
end
%matlabpool close
