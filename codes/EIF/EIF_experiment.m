...
tic
for i=1:NT
    [vals_05(:,i),P_EIF_05(:,i)]=EIF_statistics(-60,0.17,6.23,N);
end
toc
...
% 
% for i=1:NT
%     [vals_1(:,i),P_EIF_1(:,i)]=EIF_statistics(-60,0.305,6.23,N);
% end
% 
...
% 
% for i=1:NT
%     [vals_25(:,i),P_EIF_25(:,i)]=EIF_statistics(-60,0.598,6.23,N);
% end
% 
