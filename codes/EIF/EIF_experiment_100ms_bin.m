...
if(exist('./EIF_statistics.mexmaci64','file')~=3)
    mex ./mex_source/mex_main.cpp...
        ...
        -lm -lgsl -lgslcblas -output EIF_statistics_100ms
end
...
%parfor i=1:NT
for i=1:NT
    [vals_05(:,i),P_EIF_05(:,i)]=EIF_statistics_100ms(-60,0.268,3.828,N);
end
toc
...
%parfor i=1:NT
for i=1:NT
    [vals_1(:,i),P_EIF_1(:,i)]=EIF_statistics_100ms(-60,0.425,3.828,N);
end
...
%parfor i=1:NT
for i=1:NT
    [vals_25(:,i),P_EIF_25(:,i)]=EIF_statistics_100ms(-60,0.672,3.828,N);
end
%matlabpool close
