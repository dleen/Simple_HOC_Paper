...
if(exist('./EIF_statistics_100ms_long.mexmaci64','file')~=3)
    mex ./mex_source/mex_main.cpp...
        ...
        -lm -lgsl -lgslcblas -output EIF_statistics_100ms_long
end
...
%parfor i=1:NT
for i=1:NT
    [vals_05(:,i),P_EIF_05(:,i)]=EIF_statistics_100ms_long(-62.02,0.194,6.23,N);
end
toc
...
%parfor i=1:NT
for i=1:NT
    [vals_1(:,i),P_EIF_1(:,i)]=EIF_statistics_100ms_long(-62.02,0.33,6.23,N);
end
...
%parfor i=1:NT
for i=1:NT
    [vals_25(:,i),P_EIF_25(:,i)]=EIF_statistics_100ms_long(-62.02,0.609,6.23,N);
end
%matlabpool close
