...
%parfor i=1:NT
for i=1:NT
    [vals_05(:,i),P_EIF_05(:,i)]=EIF_statistics(-58.2,0.135,6.23,N);
end
toc
...
%parfor i=1:NT
for i=1:NT
    [vals_1(:,i),P_EIF_1(:,i)]=EIF_statistics(-58.2,0.256,6.23,N);
end
...
%parfor i=1:NT
for i=1:NT
    [vals_25(:,i),P_EIF_25(:,i)]=EIF_statistics(-58.2,0.55,6.23,N);
end
%matlabpool close
